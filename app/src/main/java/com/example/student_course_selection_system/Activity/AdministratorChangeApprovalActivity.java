...
public class AdministratorChangeApprovalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrator_change_approval);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("caozuo",selectedValue);
                Thread thread = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        try {
                            final String response = NetUtilPlus.net("administrators/changeApproval", params, "PUT");
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    if (response != null && response.equals("true")) {
                                        Toast.makeText(AdministratorChangeApprovalActivity.this, "审批成功！", Toast.LENGTH_SHORT).show();
                                    } else {
                                        System.out.println(response);
                                        Toast.makeText(AdministratorChangeApprovalActivity.this, "审批失败了，操作出现了错误喵~", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        } catch (Exception e) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdministratorChangeApprovalActivity.this,AdministratorApprovalActivity.class);
